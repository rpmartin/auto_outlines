...
* Assignments are based on data from  the experiments.
  ...
  * Only need to do 4 out of the 6 assignments to get full marks (52%).  
* Participation: Experiments 1,2,4,5,6 have 20 rounds: you earn .1% per round completed.
  * Must start the experiment within the first 4 minutes of class. 
  * Must complete each round within 2 minutes.
  * Maximum incentive mark is 8%: you only need to finish 4 of the 6 experiments.
