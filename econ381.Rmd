...
* Assignments are based on data from  the experiments.
  ...
  * Maximum assignment mark is 50%: best 5 of 6 assignments count.  
* Participation: Experiments 1,2,4,5,6 have 20 rounds: you earn .1% per round completed.
  ...
  * Maximum incentive mark is 10%: best 5 of 6 experiments count.
...
* Hand in assignments late, but you only need to do 5 of 6.
